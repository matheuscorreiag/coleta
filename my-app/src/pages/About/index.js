  ...
  return (
    <div className="about">
      ...
      <div className="mid-about">
        <h1>Somos a Comissão de Gestão Ambiental da Universidade Federal da Paraíba</h1>
        <p>
          ...
          páginas web usam actualmente o Lorem Ipsum como o modelo de texto usado por omissão, e uma
          pesquisa por "lorem ipsum" irá encontrar muitos websites ainda na sua infância. Várias
          versões têm evoluído ao longo dos anos, por vezes por acidente, por vezes propositadamente
